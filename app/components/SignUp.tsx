...
export default function SignUp() {
  ...
  const onSubmit = async (data: TSignUpSchema) => {
    // const signInData = await signIn('credentials', {email: data.email, password: data.password});
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-primary ">
        ...
        <Link
          className="hover:text-blue-700 text-blue-500 font-semibold transition-colors duration-150"
          href="/sign-in"
        >
          Login
        </Link>
